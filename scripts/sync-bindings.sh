...
# MDK_DIR points at the mdk Rust checkout (the repo formerly known as
# darkmatter). The legacy DARKMATTER_DIR name is honored as a fallback.
MDK_DIR="${MDK_DIR:-${DARKMATTER_DIR:-$(cd "$IOS_DIR/../mdk" && pwd)}}"
